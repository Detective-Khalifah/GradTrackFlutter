# GradTrack
A Mobile System for Student Data Collection and Graduation Tracking.

Note: This prototype is simply a generated UI (without the UX) from [Flutlab](https://flutlab.io)'s F2F (FigmaToFlutter) Converter. It simply illustrates what the project should look like.
Install from "Releases" to check it out!
